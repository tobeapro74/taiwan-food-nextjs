...
export const taiwanFoodMap: TaiwanFoodData = {
  ...
  "훠궈": [
    ...
    {"이름": "하이디라오 신이점", "위치": "타이베이 101 근처 신이구", "특징": "4가지 육수 선택, 면 뽑기 퍼포먼스와 변검쇼, 하겐다즈 무한리필", "평점": 4.5, "리뷰수": 32000},
    ...
    {"이름": "청화자오 광푸남점 (青花驕)", "위치": "타이베이 다안구 광푸남로 100호", "특징": "왕품그룹 마라훠궈, 청화초 마라탕과 산채백육과 유명, 국부기념관역 근처"}
  ],
  "공차": [
